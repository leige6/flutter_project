...
///https://www.jianshu.com/p/b7ca56cf7b6d
/// @desc:屏幕适配
/// @time 2019/3/11 5:07 PM
/// @author Cheney
///
/// 使用前必须初始化 BaseSize.getInstance().init(context);
class BaseSize {
  static BaseSize instance = BaseSize();
...
//    print("lcfarm init scaleWidth=${_screenWidth / instance.width}");
  ...
  ///导航栏高度 刘海屏会更高 dp
  static double get navgationBarHeight => _statusBarHeight + kToolbarHeight;

  ///导航栏高度  刘海屏会更高 px
  static double get navgationBarHeightPx =>
      (_statusBarHeight * _pixelRatio) + kToolbarHeight;
